...
<template>
    <Card class="w-full bg-white/5 backdrop-blur-md border border-foreground/10 shadow-sm">
        <CardHeader>
        ...
        <CardContent>
            ...
            <div class="flex flex-wrap gap-4 pt-4 mt-4 w-full">
                <div class="flex flex-col min-w-[250px] flex-1 basis-[300px]">
            ...
            <div class="pt-4 w-full mt-4">
                <Button class="w-full h-14 text-lg flex flex-row items-center justify-center gap-4" @click="randomize">
                    <Dices class="!w-8 !h-8" />
